...
public class MyController {
    ...
    public String main(Model model, Principal principal) {
        model.addAttribute("castles", castleService.getCastles());
    ...
    public ResponseEntity<List<Castle>> getCastles() {
        return new ResponseEntity<List<Castle>>(castleService.getCastles(), HttpStatus.OK);
    }
    ...
    @RequestMapping(value = "/createcastle", method = RequestMethod.POST)
    public String createCastle(@ModelAttribute Castle castle) {
        castleService.createCastle(castle);
        return "redirect:/";
    }

    @RequestMapping(value = "/createorder", method = RequestMethod.POST)
    public String createOrder(@RequestParam(value = "castle", required = true) int castleId,
                              @RequestParam(value = "owner", required = true) int ownerId,
                              @RequestParam(value = "work", required = true) int[] works,
                              @RequestParam(value = "price", required = true) int[] price) {
        Order a = new Order();
        a.setCastle(castleService.getCastleById(castleId));
